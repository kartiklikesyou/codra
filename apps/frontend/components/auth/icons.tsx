...
export function CodraLogo({ className = "size-6" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-2.5 font-semibold tracking-tight text-white ${className}`}>
      <div className="relative flex size-7 items-center justify-center rounded-lg bg-zinc-900 border border-zinc-700/60 shadow-inner">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
      ...
      <span className="text-base font-medium tracking-tight text-zinc-100 font-mono">
        codra<span className="text-zinc-500">.</span>
      </span>
    </div>
  );
}
